...
- **SAP LBN Connectivity (2019.03 - 至今)**
  ...
  这个项目主要是向SAP Cloud Foundry中的上层应用提供各类Mircoservices。正如其名称所述，这些Mircoservices用于建立LBN Cloud Apps与不同系统（包括内部部署SAP ERP系统和非SAP系统）之间的连接。目前我负责获取Audit logs，根据不同情况分析记录并同时通知Ops team。
